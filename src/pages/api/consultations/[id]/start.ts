...
export default async function handler(req:NextApiRequest,res:NextApiResponse){
  ...
  await prisma.accessAudit.create({ data: { actorId: (session as any).user.id, actorRole: role, patientId: consultation.patientId, doctorId: consultation.doctorId, consultationId: id, action: 'CONSULTATION_STARTED' } })
